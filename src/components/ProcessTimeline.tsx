...
const STEPS = [
  {
    n: "01",
    t: "Brief",
    d: "Send your positioning, docs, and API surface. We extract intent and constraints into a tight creative brief.",
    badge: "2h",
    icon: ClipboardList,
  },
  {
    n: "02",
    t: "Structure",
    d: "Turn the brief into a semantic site map, content schema, and JSON-LD taxonomy. Architecture first.",
    badge: "4h",
    icon: GitBranch,
  },
  {
    n: "03",
    t: "Design",
    d: "High-fidelity UI in the dark. Every component is coded, not mocked — no handoff gap.",
    badge: "16h",
    icon: Layout,
  },
  {
    n: "04",
    t: "Content",
    d: "llms.txt, OpenGraph, semantic markup, sitemap + RSS. Built to be parsed by agents at ingestion.",
    badge: "18h",
    icon: Type,
  },
  {
    n: "05",
    t: "Launch",
    d: "Lighthouse audit, agent-readability check, domain handover. Live and citeable in 48 hours.",
    badge: "8h",
    icon: Rocket,
  },
];
