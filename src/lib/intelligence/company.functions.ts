      ...
      intelligence: {
        ...
        score: scoreRes.data
          ? {
              ...
              verifiability: scoreRes.data.verifiability ?? 0,
              precedent: scoreRes.data.precedent ?? 0,
              commentary: scoreRes.data.commentary ?? 0,
              information_gain: scoreRes.data.information_gain ?? 0,
              canonical: scoreRes.data.canonical ?? 0,
