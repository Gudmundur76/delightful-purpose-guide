...
export const listRegisteredMcpSitesTool = defineTool({
  ...
  description:
    "List WordPress sites that have installed grow-mcp and registered their MCP endpoint with citation.is. Returns domain, mcp_endpoint, tools_count, registered_at. Use this as the agent-native directory.",
  parameters: z.object({
