...
export function archiveLeaderboard() {
  ...
  return {
    ...
    attribution: `citation.is Agent Readability Leaderboard — ${ARCHIVE_LABEL} snapshot (CC BY 4.0)`,
    methodology_url: "https://citation.is/leaderboard/methodology",
    live_url: "https://citation.is/api/public/data/leaderboard.json",
...
export function archiveStats() {
  return {
    ...
    standard: "geo-standard@2026.07",
    license: "https://creativecommons.org/licenses/by/4.0/",
    attribution: `citation.is Agent Readability headline stats — ${ARCHIVE_LABEL} snapshot (CC BY 4.0)`,
    methodology_url: "https://citation.is/leaderboard/methodology",
    live_url: "https://citation.is/api/public/data/stats.json",
...
export function archiveClaims() {
  return {
    ...
    standard: "geo-standard@2026.07",
    license: "https://creativecommons.org/licenses/by/4.0/",
    attribution: `citation.is verifiable-claims registry — ${ARCHIVE_LABEL} snapshot (CC BY 4.0)`,
    docs: "https://citation.is/data",
    live_url: "https://citation.is/api/public/data/claims.json",
