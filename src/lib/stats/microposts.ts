...
export const STAT_MICROPOSTS: StatMicropost[] = [
  ...
  },
  {
    ...
    sources: [
      { label: "Agent Readability Leaderboard", url: "https://citation.is/leaderboard" },
      { label: "State of the Agent-Readable Web", url: "https://citation.is/stats" },
    ],
  },
  {
    ...
    sources: [
      { label: "Grow /check scanner", url: "https://citation.is/check" },
      { label: "GEO Standard §4 — crawler matrix", url: "https://citation.is/standard" },
    ],
  },
  {
    ...
    sources: [
      ...
      { label: "Free llms.txt generator", url: "https://citation.is/tools/llms-txt-generator" },
    ],
  },
  {
    ...
    sources: [
      { label: "Grow analytics cohort — methodology", url: "https://citation.is/report.methodology" },
    ],
  },
  {
    ...
    sources: [
      ...
      { label: "GEO Standard", url: "https://citation.is/standard" },
    ],
  },
  {
  ...
  },
  {
    ...
    sources: [
      ...
      { label: "citation.is — First-30% rule", url: "https://citation.is/stats/first-30-percent-earns-44-percent-of-citations" },
    ],
  },
  {
