...
const card = {
  ...
  schemaVersion: "1.0",
  name: "citation.is",
  displayName: "citation.is — GEO Standard",
  description:
  ...
  documentationUrl: "https://citation.is/api-docs",
  provider: {
    organization: "citation.is",
  ...
  endpoints: [
    ...
    {
      protocol: "openapi",
      url: "https://citation.is/openapi.json",
    },
  ],
  ...
  discovery: {
    signals: [
      { type: "agent-card", url: "https://citation.is/.well-known/agent-card.json", serves: "api-calling agents (MCP/A2A)" },
      { type: "mcp-server-card", url: "https://citation.is/.well-known/mcp/server-card.json", serves: "MCP clients" },
      { type: "llms.txt", url: "https://citation.is/llms.txt", serves: "text agents (Claude, ChatGPT, Gemini chat)" },
      { type: "in-page-marker", selector: "script[type=\"application/agent+json\"]", serves: "DOM agents (Codex, Playwright bots)" },
      { type: "visible-badge", url: "https://citation.is/badge", serves: "CUA / screenshot agents (Operator, Claude CUA)" },
      { type: "openapi", url: "https://citation.is/openapi.json", serves: "function-calling agents" },
    ],
  },
  verifiableData: {
  ...
  contact: { url: "https://citation.is/contact" },
