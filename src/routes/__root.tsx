...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Grow is a productized web design service for founders — custom, fast-loading marketing sites and landing pages shipped in 48 hours, fixed price." },
      { name: "author", content: "Grow" },
      { property: "og:title", content: "Grow — Custom websites shipped in 48 hours" },
      { property: "og:description", content: "Productized web design for founders. Custom, fast-loading marketing sites and landing pages shipped in 48 hours, fixed price." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Grow" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Grow — Custom websites shipped in 48 hours" },
      { name: "twitter:description", content: "Productized web design for founders. Custom sites shipped in 48 hours, fixed price." },
