...
const FAQS: { q: string; a: string }[] = [
  ...
  { q: "How much does a 48-hour website at Grow cost?", a: "Three fixed prices, billed once, no hourly surprises. Tier 00 (GEO Patch Pack) is free in beta — a 48-hour audit + fix list for an existing site. Tier 01 (Starter) is $2,400 USD for a single-page launch site delivered in 48 hours. Tier 02 (Growth) is $4,800 USD for up to 5 pages delivered in roughly 5 days. Every tier includes design, custom code, on-page SEO, responsive layouts, JSON-LD, llms.txt, and deployment. Copy and stock imagery are on you; we can recommend writers if needed." },
