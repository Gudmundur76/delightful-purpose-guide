...
const CONTENT = `# grow.contact — Full Content
...
grow.contact builds agent-native websites for AI startups. Every site we deliver is engineered to be cited by ChatGPT, Perplexity, Claude, and Google AI Overviews — with semantic HTML, JSON-LD structured data, llms.txt, and a verified agent-readability score. Fixed price. 48-hour delivery.
...
Run the grow.contact /check scanner on your existing site across six signals (Semantic HTML, JSON-LD, llms.txt, Citability, Speed, Protocol Discovery). Get a prioritized fix list.
...
3. Score — every page passes the grow.contact /check scanner at 90+/100 before review.
...
A 0–100 score across six signals: Semantic HTML, JSON-LD, llms.txt, Citability, Page Speed, Protocol Discovery. Run the free scanner at https://grow.contact/check.
...
Email hello@grow.contact or start a brief at https://grow.contact/contact.
`;
